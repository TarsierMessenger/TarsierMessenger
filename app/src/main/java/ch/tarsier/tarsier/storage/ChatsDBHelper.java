...
public class ChatsDBHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_CHATROOMS = CREATE_TABLE
            + ChatsContract.Discussion.TABLE_NAME + " (" + ChatsContract.Discussion._ID
            + ChatsContract.Discussion.COLUMN_NAME_CHAT_ID + " INTEGER PRIMARY KEY," + TEXT_TYPE
            + COMMA_SEP + ChatsContract.Discussion.COLUMN_NAME_TITLE + TEXT_TYPE + COMMA_SEP
            + ChatsContract.Discussion.COLUMN_NAME_HOST + TEXT_TYPE + " )";

    private static final String SQL_CREATE_MESSAGES = CREATE_TABLE
            + ChatsContract.Message.TABLE_NAME + ChatsContract.Message._ID + " ("
            + " INTEGER PRIMARY KEY," + ChatsContract.Message.COLUMN_NAME_MSG + TEXT_TYPE
            + COMMA_SEP + ChatsContract.Message.COLUMN_NAME_DATETIME + DATETIME_TYPE + COMMA_SEP
